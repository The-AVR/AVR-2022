...
When setting wifi be sure to run as python3 not just python. Since you are using sudo, it defaults to the system python path, not the venv, so you you need to declare version.
